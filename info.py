...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://copakim927:copakim927@cluster0.j6qikzi.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Sujan_BotZ")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/Sujan_BotZ') # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Sujan_BotZ') # Tutorial video link for opening shortlink website 
